    ...
    for mes in range(12):
        if quincenas[mes][0].get() == 1 or quincenas[mes][1].get() == 1:
            ...
            if mes not in plantas_avistadas[planta]:
                ...
                lista_plantas.insert(tk.END, f"{planta} (Mes: {meses[mes]})")
...
icon_path = "ruta/a/icono_de_abeja.ico"  # Reemplazar con la ruta correcta al ícono de abeja
...
# Lista para mostrar las plantas agregadas con el mes (sin repetición)
